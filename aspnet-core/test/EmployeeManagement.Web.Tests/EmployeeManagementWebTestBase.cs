...
{
    public abstract class EmployeeManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeeManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeeManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeeManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeeManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeeManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeeManagementDbContext, Task<T>> func)
        {
            T result;
